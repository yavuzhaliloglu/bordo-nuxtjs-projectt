<template>
    <form class="form d-flex flex-row justify-content-between align-items-center" @submit.prevent="loginUser">
        <div class="form-content d-flex flex-column justify-content-center align-items-center text-center">
            ...
            <div class="form-content-container">
                ...
                <div class="form-content-container-input">
                    ...
                    <input id="email" type="email" placeholder="E-mail *" v-model="logininfo.email">
                </div>

                <div class="form-content-container-input">
                    <font-awesome-icon icon="fa-solid fa-lock" />
                    <input id="password" type="password" placeholder="Password *" v-model="logininfo.password">
                </div>

                <div class="form-content-container-buttons d-flex flex-row justify-content-between align-items-center">
                    <LinksButtonComponent class="login-button " :text="text" :type="type" />
                    <span class="w-50">Henüz hesabın yok mu? <nuxt-link class="signup-link" to="/signup">Kayıt Ol
                        </nuxt-link></span>
                </div>
            </div>
        </div>
